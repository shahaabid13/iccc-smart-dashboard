  ...
  loadDeviceInfo(deviceId) {
    this.http.get(`/api/devices/${deviceId}`).subscribe({
      next: (data) => {
        ...
        this.deviceInfo = __spreadProps(__spreadValues({}, data), {
          currentSerial,
          currentLocation,
...
(() => {
  ...
  `, styles: ["/* angular:styles/component:scss;88f5e59b1702e7a36dbf83e5cb7042198650efcb66f5c5f539c18bb19f999cbd;C:/Users/Administrator/Documents/GitHub/iccc-smart-dashboard/src/app/components/devices/device-history/device-history.component.ts */\n.page-container {\n  padding: 20px;\n  background: #f5f7fa;\n  min-height: 100vh;\n}\n.history-card {\n  border-radius: 16px;\n  overflow: hidden;\n  background: white;\n}\n.header-section {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 24px;\n  background:\n    linear-gradient(\n      135deg,\n      #667eea 0%,\n      #764ba2 100%);\n  color: white;\n}\n.header-content {\n  display: flex;\n  align-items: center;\n  gap: 16px;\n}\n.back-btn {\n  color: white;\n  background: rgba(255, 255, 255, 0.2);\n}\n.title-section h1 {\n  margin: 0;\n  font-size: 28px;\n  font-weight: 700;\n  letter-spacing: -0.5px;\n}\n.subtitle {\n  margin: 4px 0 0 0;\n  opacity: 0.9;\n  font-size: 14px;\n}\n.refresh-btn {\n  background: rgba(255, 255, 255, 0.2);\n  color: white;\n  border: 1px solid rgba(255, 255, 255, 0.3);\n}\n.device-summary-card {\n  margin: 20px 24px;\n  border-left: 4px solid #667eea;\n}\n.device-info-grid {\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(250px, 1fr));\n  gap: 16px;\n}\n.device-info-item {\n  display: flex;\n  flex-direction: column;\n  gap: 4px;\n}\n.label {\n  font-size: 12px;\n  color: #111010;\n  text-transform: uppercase;\n  font-weight: 600;\n  font-style: bold;\n}\n.value {\n  font-size: 16px;\n  font-weight: 500;\n  color: #251919;\n}\n.serial {\n  color: #667eea;\n  font-weight: 600;\n}\n.status-chip {\n  font-weight: 600;\n  text-transform: uppercase;\n  font-size: 11px;\n}\n.status-active {\n  background: #4caf50 !important;\n  color: white !important;\n}\n.status-inactive {\n  background: #dacccc !important;\n  color: white !important;\n}\n.status-maintenance {\n  background: #ff9800 !important;\n  color: white !important;\n}\n.loading-container {\n  text-align: center;\n  padding: 60px 20px;\n}\n.loading-text {\n  margin-top: 16px;\n  color: #666;\n  font-size: 16px;\n}\n.table-section {\n  padding: 0 24px 24px;\n}\n.table-header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 20px;\n}\n.table-header h3 {\n  margin: 0;\n  color: #333;\n  font-size: 20px;\n  font-weight: 600;\n}\n.record-count {\n  background: #e3f2fd;\n  color: #1976d2;\n  padding: 6px 12px;\n  border-radius: 16px;\n  font-size: 12px;\n  font-weight: 600;\n}\n.table-container {\n  border: 1px solid #e0e0e0;\n  border-radius: 12px;\n  overflow: hidden;\n}\n.history-table {\n  width: 100%;\n}\nth.mat-header-cell {\n  background: #f8f9fa;\n  font-weight: 600;\n  color: #b19e9e;\n  font-size: 13px;\n  text-transform: uppercase;\n  letter-spacing: 0.5px;\n  padding: 16px;\n  border-bottom: 2px solid #e0e0e0;\n}\ntd.mat-cell {\n  padding: 16px;\n  border-bottom: 1px solid #f0f0f0;\n  vertical-align: top;\n}\n.action-chip {\n  font-weight: 600;\n  text-transform: uppercase;\n  font-size: 11px;\n}\n.action-install {\n  background: #4caf50 !important;\n  color: white !important;\n}\n.action-repair {\n  background: #ff9800 !important;\n  color: white !important;\n}\n.action-replace {\n  background: #2196f3 !important;\n  color: white !important;\n}\n.action-update {\n  background: #bcabbe !important;\n  color: white !important;\n}\n.action-move {\n  background: #607d8b !important;\n  color: white !important;\n}\n.change-comparison {\n  display: flex;\n  align-items: center;\n  gap: 8px;\n  flex-wrap: wrap;\n}\n.old-value {\n  background: #ffebee;\n  color: #c62828;\n  padding: 4px 8px;\n  border-radius: 4px;\n  font-size: 12px;\n  text-decoration: line-through;\n}\n.new-value {\n  background: #e8f5e8;\n  color: #2e7d32;\n  padding: 4px 8px;\n  border-radius: 4px;\n  font-size: 12px;\n  font-weight: 600;\n}\n.change-arrow {\n  font-size: 16px;\n  color: #666;\n}\n.no-change {\n  color: #999;\n  font-style: italic;\n}\n.additional-info {\n  display: flex;\n  flex-direction: column;\n  gap: 8px;\n}\n.info-item {\n  display: flex;\n  align-items: center;\n  gap: 6px;\n  font-size: 12px;\n  color: #666;\n}\n.info-icon {\n  font-size: 16px;\n  width: 16px;\n  height: 16px;\n}\n.timestamp {\n  text-align: center;\n}\n.date {\n  font-weight: 600;\n  color: #333;\n  font-size: 13px;\n}\n.time {\n  color: #666;\n  font-size: 11px;\n}\n.performed-by {\n  display: flex;\n  align-items: center;\n  gap: 6px;\n  font-size: 13px;\n}\n.user-icon {\n  font-size: 18px;\n  color: #666;\n}\n.recent-row {\n  background: #f3f8ff !important;\n  border-left: 3px solid #2196f3;\n}\n.empty-state {\n  text-align: center;\n  padding: 60px 20px;\n  color: #666;\n}\n.empty-icon {\n  font-size: 64px;\n  width: 64px;\n  height: 64px;\n  color: #bdbdbd;\n  margin-bottom: 16px;\n}\n.empty-state h3 {\n  margin: 0 0 8px 0;\n  color: #333;\n}\n.stats-section {\n  padding: 0 24px 24px;\n}\n.stats-card {\n  background:\n    linear-gradient(\n      135deg,\n      #667eea 0%,\n      #764ba2 100%);\n  color: white;\n}\n.stats-card h4 {\n  margin: 0 0 16px 0;\n  color: white;\n  text-align: center;\n}\n.stats-grid {\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(120px, 1fr));\n  gap: 16px;\n}\n.stat-item {\n  text-align: center;\n}\n.stat-number {\n  display: block;\n  font-size: 24px;\n  font-weight: 700;\n  margin-bottom: 4px;\n}\n.stat-label {\n  font-size: 12px;\n  opacity: 0.9;\n  text-transform: uppercase;\n}\n@media (max-width: 768px) {\n  .page-container {\n    padding: 10px;\n  }\n  .header-section {\n    flex-direction: column;\n    gap: 16px;\n    text-align: center;\n  }\n  .header-content {\n    flex-direction: column;\n  }\n  .device-info-grid {\n    grid-template-columns: 1fr;\n  }\n  .displayed-columns {\n    font-size: 12px;\n  }\n  th.mat-header-cell,\n  td.mat-cell {\n    padding: 12px 8px;\n  }\n  .stats-grid {\n    grid-template-columns: repeat(2, 1fr);\n  }\n}\n/*# sourceMappingURL=device-history.component.css.map */\n"] }]
  }], () => [{ type: ActivatedRoute }, { type: HttpClient }, { type: Router }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DeviceHistoryComponent, { className: "DeviceHistoryComponent", filePath: "src/app/components/devices/device-history/device-history.component.ts", lineNumber: 609 });
})();
export {
  DeviceHistoryComponent
};
//# sourceMappingURL=chunk-IPNXI4ED.js.map
