...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-ZC4IBORH.js").then((m) => m);
...
var routes = [
  ...
  {
    path: "login",
    loadComponent: () => import("./chunk-IHG2S63O.js").then((m) => m.LoginComponent)
  },
  {
    path: "forgot-password",
    loadComponent: () => import("./chunk-XCBTNLJH.js").then((m) => m.ForgotPasswordComponent)
  },
  {
    path: "register",
    loadComponent: () => import("./chunk-NJQFU4D7.js").then((m) => m.RegisterComponent)
  },
  {
    path: "inventory",
    loadComponent: () => import("./chunk-AFQXPRIH.js").then((m) => m.InventoryListComponent)
  },
  {
    path: "charts",
    loadComponent: () => import("./chunk-VZOJ22UN.js").then((m) => m.WeighbridgeChartsComponent)
  },
  {
    path: "smc",
    loadComponent: () => import("./chunk-YCU4LCTZ.js").then((m) => m.SmcDashboardComponent)
  },
  {
    path: "admin/excel-upload",
    loadComponent: () => import("./chunk-3FA4XXUY.js").then((m) => m.ExcelUploadComponent)
  },
  {
    path: "devices/search",
    loadComponent: () => import("./chunk-FS3IYDPT.js").then((m) => m.DeviceSearchComponent)
  },
  {
    path: "devices/:deviceId/history",
    loadComponent: () => import("./chunk-IPNXI4ED.js").then((m) => m.DeviceHistoryComponent)
  },
  {
    path: "anpr",
    children: [
  ...
  },
  {
    ...
    loadComponent: () => import("./chunk-YXDISTLE.js").then((m) => m.MaintenanceRequestComponent)
  },
  {
    path: "admin/dashboard",
    loadComponent: () => import("./chunk-JWKIDTN3.js").then((m) => m.DashboardComponent),
    canActivate: [AdminGuard]
  },
  {
    path: "admin/all-requests",
    loadComponent: () => import("./chunk-GXDIJ2RQ.js").then((m) => m.AllRequestsComponent)
  },
  {
    path: "admin/items/new",
    loadComponent: () => import("./chunk-6KX4ICT7.js").then((m) => m.ItemFormComponent),
    canActivate: [AdminGuard]
  },
  {
  ...
  },
  {
    ...
    loadComponent: () => import("./chunk-DXTNOIJ5.js").then((m) => m.PageNotFoundComponent)
  },
  {
    path: "coming-soon",
    loadComponent: () => import("./chunk-U6OJWE4Q.js").then((m) => m.ComingSoonComponent)
  },
  {
    path: "pbs/stations",
    loadComponent: () => import("./chunk-VJOEHOGC.js").then((m) => m.PbsStationsComponent)
  },
  {
    path: "pbs/analytics",
    loadComponent: () => import("./chunk-WAA74LZI.js").then((m) => m.PbsAnalyticsComponent)
  },
  {
    path: "chartered-bike",
    loadComponent: () => import("./chunk-D2QVJXLO.js").then((m) => m.CharteredBikeDashboardComponent)
  },
  {
    path: "chartered-bike/stations",
    loadComponent: () => import("./chunk-P77BHOU7.js").then((m) => m.CharteredBikeStationsComponent)
  },
  {
    path: "chartered-bike/history",
    loadComponent: () => import("./chunk-TLJE3KBF.js").then((m) => m.CharteredBikeHistoryComponent)
  },
  {
    path: "chartered-bike/statistics",
    loadComponent: () => import("./chunk-L5CF3UJ5.js").then((m) => m.CharteredBikeStatsComponent)
  },
  {
    path: "chartered-bike/reports",
    loadComponent: () => import("./chunk-5JT53WCQ.js").then((m) => m.CharteredBikeReportsComponent)
  },
  // fallback
...
function isAdminProtectedRoute(url) {
  try {
...
function HeaderComponent_span_39_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.openDropdown === "charteredBike" ? "\u25B2" : "\u25BC", " ");
  }
}
function HeaderComponent_div_40_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 32)(1, "a", 45);
    ...
    \u0275\u0275listener("click", function HeaderComponent_div_40_Template_a_click_16_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeSidebarIfMobile());
    });
    ...
    \u0275\u0275text(20, "Statistics");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(21, "a", 49);
    \u0275\u0275listener("click", function HeaderComponent_div_40_Template_a_click_21_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeSidebarIfMobile());
    });
...
function HeaderComponent_div_48_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 32)(1, "a", 50);
...
function HeaderComponent_div_58_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(7, HeaderComponent_div_58_ng_container_1_ng_container_7_Template, 5, 0, "ng-container", 64);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function HeaderComponent_div_58_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, HeaderComponent_div_58_ng_container_1_Template, 8, 3, "ng-container", 61)(2, HeaderComponent_div_58_ng_template_2_Template, 4, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var HeaderComponent = class _HeaderComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HeaderComponent, selectors: [["app-header"]], hostBindings: function HeaderComponent_HostBindings(rf, ctx) {
  ...
  }, decls: 60, vars: 40, consts: [["guestOptions", ""], [1, "header-layout"], ["class", "mobile-toggle", 3, "click", 4, "ngIf"], [1, "sidebar"], [1, "sidebar-header"], ["class", "dashboard-title", 4, "ngIf"], [1, "sidebar-toggle", 3, "click"], [1, "toggle-icon"], [1, "sidebar-nav"], ["class", "nav-section", 4, "ngIf"], [1, "dropdown-container"], [1, "dropdown-header", 3, "click"], [1, "dropdown-icon"], ["class", "dropdown-title", 4, "ngIf"], ["class", "dropdown-arrow", 4, "ngIf"], ["class", "dropdown-content", 4, "ngIf"], ["class", "sidebar-footer", 4, "ngIf"], [1, "app-header"], [1, "logo-container"], ["src", "/logo.jfif", "alt", "Logo", 1, "logo-img"], [1, "logo-text"], [1, "auth"], [1, "profile", 3, "click"], ["src", "/download.png", "alt", "Profile", 1, "profile-icon"], ["class", "dropdown", 3, "click", 4, "ngIf"], ["class", "mobile-overlay", 3, "click", 4, "ngIf"], [1, "mobile-toggle", 3, "click"], [1, "dashboard-title"], [1, "nav-section"], [1, "section-label"], [1, "dropdown-title"], [1, "dropdown-arrow"], [1, "dropdown-content"], ["routerLink", "/inventory", "routerLinkActive", "active", 1, "dropdown-item", 3, "click"], [1, "item-icon"], ["routerLink", "/admin/dashboard", "routerLinkActive", "active", "class", "dropdown-item", 3, "click", 4, "ngIf"], ["routerLink", "/admin/all-requests", "routerLinkActive", "active", "class", "dropdown-item", 3, "click", 4, "ngIf"], ["routerLink", "/maintenance/request", "routerLinkActive", "active", "class", "dropdown-item", 3, "click", 4, "ngIf"], ["routerLink", "/admin/dashboard", "routerLinkActive", "active", 1, "dropdown-item", 3, "click"], ["routerLink", "/admin/all-requests", "routerLinkActive", "active", 1, "dropdown-item", 3, "click"], ["routerLink", "/maintenance/request", "routerLinkActive", "active", 1, "dropdown-item", 3, "click"], ["routerLink", "/smc", "routerLinkActive", "active", 1, "dropdown-item", 3, "click"], ["routerLink", "/charts", "routerLinkActive", "active", 1, "dropdown-item", 3, "click"], ["routerLink", "/pbs/stations", "routerLinkActive", "active", 1, "dropdown-item", 3, "click"], ["routerLink", "/pbs/analytics", "routerLinkActive", "active", 1, "dropdown-item", 3, "click"], ["routerLink", "/chartered-bike", "routerLinkActive", "active", 1, "dropdown-item", 3, "click"], ["routerLink", "/chartered-bike/stations", "routerLinkActive", "active", 1, "dropdown-item", 3, "click"], ["routerLink", "/chartered-bike/history", "routerLinkActive", "active", 1, "dropdown-item", 3, "click"], ["routerLink", "/chartered-bike/statistics", "routerLinkActive", "active", 1, "dropdown-item", 3, "click"], ["routerLink", "/chartered-bike/reports", "routerLinkActive", "active", 1, "dropdown-item", 3, "click"], ["routerLink", "/anpr/analytics-table", "routerLinkActive", "active", 1, "dropdown-item", 3, "click"], ["routerLink", "/anpr/analytics-charts", "routerLinkActive", "active", 1, "dropdown-item", 3, "click"], ["routerLink", "/anpr/bus-analytics", "routerLinkActive", "active", 1, "dropdown-item", 3, "click"], [1, "sidebar-footer"], [1, "user-info"], ["src", "/download.png", "alt", "Profile", 1, "user-avatar"], [1, "user-details"], [1, "user-name"], [1, "user-role"], [1, "version-info"], [1, "dropdown", 3, "click"], [4, "ngIf", "ngIfElse"], [3, "click"], ["routerLink", "/login", 1, "dropdown-link", 3, "click"], [4, "ngIf"], ["routerLink", "/register", 1, "dropdown-link", 3, "click"], ["routerLink", "/forgot-password", 1, "dropdown-link", 3, "click"], [1, "mobile-overlay", 3, "click"]], template: function HeaderComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275listener("click", function HeaderComponent_Template_div_click_35_listener() {
        return ctx.toggleDropdown("charteredBike");
      });
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275template(40, HeaderComponent_div_40_Template, 26, 0, "div", 15);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275template(48, HeaderComponent_div_48_Template, 16, 0, "div", 15);
      \u0275\u0275elementEnd()();
    ...
    if (rf & 2) {
      ...
      \u0275\u0275property("ngIf", !ctx.isSidebarCollapsed);
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.openDropdown === "charteredBike" && !ctx.isSidebarCollapsed);
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", !ctx.isSidebarCollapsed);
      \u0275\u0275advance();
      \u0275\u0275classProp("collapsed", ctx.isSidebarCollapsed);
      ...
      <nav class="sidebar-nav">
        ...
        <div class="dropdown-container" [class.collapsed]="isSidebarCollapsed">
          ...
          <div class="dropdown-content" *ngIf="openDropdown === 'pbs' && !isSidebarCollapsed">
            <a routerLink="/pbs/stations" routerLinkActive="active" class="dropdown-item" (click)="closeSidebarIfMobile()">
              <span class="item-icon">\u{1F6B2}</span>
        ...
        <div class="dropdown-container" [class.collapsed]="isSidebarCollapsed">
          <div class="dropdown-header" (click)="toggleDropdown('charteredBike')">
            <span class="dropdown-icon">\u{1F6B4}</span>
          ...
          <div class="dropdown-content" *ngIf="openDropdown === 'charteredBike' && !isSidebarCollapsed">
            <a routerLink="/chartered-bike" routerLinkActive="active" class="dropdown-item" (click)="closeSidebarIfMobile()">
              <span class="item-icon">\u{1F3E0}</span>
              <span>Dashboard</span>
            </a>
...
var App = class _App {
  ...
  static \u0275fac = function App_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _App)(\u0275\u0275directiveInject(SidebarService), \u0275\u0275directiveInject(AuthService));
  };
...
(() => {
  ...
  }], () => [{ type: SidebarService }, { type: AuthService }], null);
})();
(() => {
